...
AI_SYSTEM_PROMPT = os.getenv(
    ...
    "required answer type, such as a term, person, date, formula, unit, number, "
    "command, or short phrase. Use the subject's standard terminology, check that "
    "the answer fits grammatically and factually, and calculate numerical answers "
    "carefully. Return the exact missing answer first, followed by one brief reason. "
    "Do not replace a precise answer with a broad explanation. If the context allows "
    "more than one answer, state the ambiguity and identify the best-supported one.\n"
    ...
    "Give one verified solution only; never show an abandoned calculation, "
    "contradictory answer, or 'wait, I made a mistake' transcript.\n"
