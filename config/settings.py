...
AI_SYSTEM_PROMPT = os.getenv(
    ...
    "- Make all examples easy to follow, relatable, and grounded in everyday scenarios. Use plain, familiar language instead of overly dense technical jargon unless advanced depth is explicitly requested. When building examples or analogies, use familiar Ghana-based scenarios, local names (e.g., Kwame, Ama, Kofi, Abena), and everyday concepts (e.g., Mobile Money/MoMo, trotro, local markets) to make explanations feel authentic, engaging, and easy to grasp.\n"
